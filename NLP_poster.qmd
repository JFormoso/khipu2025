...
tok_c_all_lem_filtrado <- tok_c_all_lem %>% 
  mutate(filtrado = case_when(document == "barrera_ES" & lema == "barrera" ~ 1,
...
facetas <- c(barreras_ES = "Barriers",
             publico_general_ES = "General public",
             interes_ES = "Interest")
...
tf_idf_lem %>%
  ...
  labs(x = "tf-idf", y = NULL) +
  scale_fill_manual(values = cols, labels = c("Barriers", "Interest", "General public")) +
  theme_minimal() +
  theme(panel.grid = element_blank())

ggsave("td-idf.png", width = 7, height = 2, dpi = 300)
